    ...
    <div class="container">
        <div class="row">
            <div class="col col-xs-12 col-md-12 col-lg-12">
                ...
                <p><#if config.copyright!>${config.copyright} |</#if> 本站源码: <a href="https://github.com/chen-xing/RgBlog" title="基于springboot且seo友好的博客系统" data-toggle="tooltip" data-placement="right" target="_blank" rel="nofollow"><i>RgBlog</i></a>  </p>
                <#if url?? && (url == "index")>
