...
<@header title="${config.siteName!}|一个程序员的个人博客|前端学习"
                    ...
                    <article class="fade-in">
                        ...
                        <div class="entry-content">
                            ...
                            <span class="entry-meta">
                                <span class="date" title="文章发表日期" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-clock-o fa-fw"></i>${item.createTime?string('yyyy-MM-dd HH:mm:ss')}</span>
