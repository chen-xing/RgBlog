...
$(function () {
    ...
    console.group("关于人工博客");
    console.log("人工博客，一个简洁美观、功能强大并且自适应的Java博客");
    console.groupEnd();
    console.log("%c成功没捷径，一切皆汗水！", "color:green;font-size:20px;font-weight:blod");
    console.groupEnd();
    console.log("努力用心做好每件小事，成功定会如期而至");
