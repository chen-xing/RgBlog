                            ...
                            <#if searchOptions?? && (searchOptions?size > 0)>
                                <#list searchOptions as item>
                                    <li><a class="pointer" rel="external nofollow"><span
                                                    class="label label-info">${item}</span></a></li>
                                </#list>
                            </#if>
                        </@zhydTag>
                    </ul>
            ...
            <div class="row">
                <div class="col col-xs-12 col-md-12 col-lg-12">
                    ...
                    <ul class="list-unstyled list-inline">
                        ...
                        <li><a href="${config.siteUrl}/archives" title="归档目录" data-toggle="tooltip"
                               data-placement="bottom"><i class="fa fa-folder-o fa-fw"></i>归档目录</a></li>
...
<footer class="footer">
    <div class="container">
        <div class="row">
            <div class="col col-xs-12 col-md-12 col-lg-12">
                <p><#if config.copyright!>${config.copyright} |</#if> 本站源码: <a
                            href="https://github.com/chen-xing/RgBlog" title="基于springboot且seo友好的博客系统"
                            data-toggle="tooltip" data-placement="right" target="_blank"
                            rel="nofollow"><i>RgBlog</i></a></p>
                <#if url?? && (url == "index")>
...
<#--<script type="text/javascript"-->
<#--        src="https://static.gzcx.net/cdn/bootstrapvalidator@0.5.4/js/bootstrapValidator.min.js"></script>-->
...
<script type="text/javascript"
        src="https://cdn.staticfile.org/jquery-confirm/3.3.2/jquery-confirm.min.js"></script>
<script type="text/javascript"
        src="https://cdn.staticfile.org/fancybox/2.1.5/jquery.fancybox.min.js"></script>
<script type="text/javascript"
        src="https://static.gzcx.net/cdn/bootstrapvalidator@0.5.4/js/bootstrapValidator.min.js"></script>
